...
//                            })
        ...
        foreach ($customer_list as $row) {
            ...
            $action .= "<a class='btn btn-primary btn-sm mr-2' href='customer/" . $row->id . "'>View</a>";

            // if (Auth::user()->can('edit-customer')) {
                $action .= "<a class='btn btn-success btn-sm mr-2' href='customer/" . $row->id . "/edit'>Edit</a>";
            // }

            if (Auth::user()->can('delete-customer')) {
                $action .= "<form action='" . url('customer', $row->id) . "' method='POST' style='display: inline-block;'>"
                        . csrf_field() . ""
                        . method_field('DELETE') . "
