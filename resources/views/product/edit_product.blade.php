                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="main_category">
                                                ...
                                                @foreach($all_category as $row)
                                                    <option @if($product_data->main_category == $row->id) selected @endif value="{{ $row->id }}">
                                                        {{ $row->category_name }}
                                                    </option>
                                                @endforeach
                                            </select>
...
<script src="{{ asset('public/admin_asset/dist/js/dropzone.js') }}"></script>
<script>
    if ($("#myId").length) {
