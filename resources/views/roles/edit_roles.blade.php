...
<div class="col-12 pt-5">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Roles Info</h4>
            ...
            <form id="add_form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="{{ $role_data->name }}" placeholder="Role Name">
                    </div>
                </div>
                        ...
                        <td>
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    id="inlineCheckbox{{$key}}_{{ $loop->iteration }}" value="{{ $row->id }}" @if(in_array($row->id, $role_wise_permission_array)) checked @endif>
